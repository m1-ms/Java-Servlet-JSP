...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .item-bar-id { font-size: 13px; color: #888780; font-weight: 500; }
    ...
    .btn-back:hover { color: #0F6E56; }
    .btn-submit {
      height: 40px; padding: 0 24px; border-radius: 8px; border: none;
      background: #0F6E56; color: #fff; font-size: 13px; font-weight: 500;
  ...
  <div class="card">
    <div class="card-top">
      <div class="card-icon-row">
        <div class="card-icon"><i class="ti ti-file-plus"></i></div>
        <h1 class="card-title">Add <span>Details</span></h1>
      </div>
      <div class="item-bar">
        <div class="item-bar-item">
          <p class="item-bar-label">ID</p>
          <p class="item-bar-id">#<%= itemId %></p>
        </div>
    ...
    <form action="ItemController" method="post">
      <input type="hidden" name="action" value="addItemDetail">
      <input type="hidden" name="itemId" value="<%= itemId %>">

      <div class="field">
        <label for="description">Description</label>
        <textarea id="description" name="description" placeholder="e.g. Gaming Laptop with RTX 4090"></textarea>
      </div>
      <div class="field">
        <label for="manufacturer">Manufacturer</label>
        <input type="text" id="manufacturer" name="manufacturer" placeholder="e.g. Dell">
      </div>
      ...
      <div class="actions">
        ...
        <button type="submit" class="btn-submit">
          <i class="ti ti-check" style="font-size:15px"></i> Add Details
        </button>
      </div>
    </form>
  </div>
