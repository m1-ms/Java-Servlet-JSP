...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .field input::placeholder { color: #B4B2A9; letter-spacing: 0; text-align: left; }
...
<body>
  <div class="card">
    ...
    <form action="AuthController" method="post">
      ...
      <div class="actions">
        <a href="forgotPassword.jsp" class="btn-back">
          <i class="ti ti-arrow-left" style="font-size:15px"></i> Back
        </a>
        <button type="submit" class="btn-submit">
          <i class="ti ti-check" style="font-size:15px"></i> Verify OTP
        </button>
      </div>
    </form>
  </div>
