	...
	<div class="main">
		<div class="topbar">
			...
			<div class="topbar-right">
				...
				<a href="AdminController?action=showDashboard" class="back-btn"><i
		...
		<div class="content">
			...
			<div class="table-card">
				<div class="table-head">
					<span class="table-title">Accounts</span> <span class="count-tag"><%=totalAccounts%>
						accounts</span>
				</div>
				<div class="search-wrap">
					<i class="ti ti-search search-icon"></i> <input type="text"
						class="search-inp" id="search-inp"
						...
						<tbody id="table-body">
							...
							<tr>
								...
								<td style="text-align: center;"><span
									class="badge <%=acc.getRole().equals("ADMIN") ? "b-admin" : "b-user"%>"><%=acc.getRole()%></span></td>
								<td style="text-align: center;"><span
									class="badge <%=acc.isActive() ? "b-active" : "b-inactive"%>"><%=acc.isActive() ? "Active" : "Inactive"%></span></td>
								<td style="text-align: center; white-space: nowrap;">
									...
									<form action="AdminController" method="post"
										...
										<button type="submit" class="deactivate-btn">
											<i class="ti ti-user-off" style="font-size: 12px;"></i>
											Deactivate
										</button>
									</form> <%
 } else {
 %>
									<form action="AdminController" method="post"
										...
										<input type="hidden" name="userName"
											value="<%=acc.getUsername()%>">
										<button type="submit"
											style="padding: 4px 10px; background: #F0FAF4; border: 1px solid rgba(40, 179, 72, 0.2); border-radius: 6px; font-size: 11px; font-weight: 600; color: #28B348; cursor: pointer; font-family: 'Inter', sans-serif; display: inline-flex; align-items: center; gap: 4px;">
